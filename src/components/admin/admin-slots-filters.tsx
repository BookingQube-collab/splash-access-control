...
export function AdminSlotsFilters({
  filters,
  onFiltersChange,
  mode,
  onModeChange,
      ...
      <div className={cn(ADMIN_CARD, "p-5 sm:p-6")}>
        <div className="grid gap-4 lg:grid-cols-12">
          <div className="lg:col-span-3">
            <Label className="mb-1.5 block text-xs font-semibold text-[#64748b]">Search</Label>
          ...
          <div className="lg:col-span-2">
            <Label className="mb-1.5 block text-xs font-semibold text-[#64748b]">Slot</Label>
            <SearchableSelect
          ...
          <div className="lg:col-span-2">
            <Label className="mb-1.5 block text-xs font-semibold text-[#64748b]">Status</Label>
            <SearchableSelect
          ...
          <div className="lg:col-span-3">
            <Label className="mb-1.5 block text-xs font-semibold text-[#64748b]">Date range</Label>
        ...
        <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-[#f1f5f9] pt-5">
          <div className="flex flex-wrap items-center gap-3">
            <span className="text-xs font-semibold text-[#64748b]">Filter mode</span>
            <div
            ...
            >
              {(["local", "server"] as const).map((m) => (
                <button
                  ...
                  className={cn(
                    "rounded-[10px] px-3.5 py-1.5 text-xs font-semibold capitalize transition",
        ...
        <div className="flex flex-wrap items-center gap-2 px-1">
          {chips.map((chip) => (
            <span
              ...
              className="inline-flex items-center gap-1 rounded-full border border-[#e2e8f0] bg-white px-2.5 py-1 text-xs font-medium text-[#334155]"
            >
              {chip.label}
              {chip.key !== "mode" && (
                <button
