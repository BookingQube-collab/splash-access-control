      ...
      <PosField icon={<QrCode className="h-3.5 w-3.5 text-[#00a8b5]" />} label="Scan barcode / QR">
        ...
        <motion.div layout className="flex items-center gap-2">
          ...
          <Input
            ...
            className={cn(INPUT_CLASS, "flex-1 uppercase placeholder:normal-case")}
          ...
          <button
            ...
            className="inline-flex h-10 shrink-0 items-center gap-1.5 rounded-xl bg-[#00a8b5] px-4 text-[11px] font-bold uppercase tracking-wide text-white shadow-[0_8px_20px_-6px_rgba(0,168,181,0.5)] transition hover:bg-[#009199]"
      ...
      <PosField icon={<User className="h-3.5 w-3.5 text-[#00a8b5]" />} label="Full name">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={cn(INPUT_CLASS, fieldsLoading && "pr-9 opacity-90")}
